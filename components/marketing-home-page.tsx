...
function FeatureCard({ icon: Icon, title, body }: { icon: typeof GridIcon; title: string; body: string }) {
  return (
    <div className="panel p-5">
      ...
      <h3 className="mt-4 font-display text-[1.7rem] font-extrabold leading-[1.02]  text-[color:var(--foreground)]">{title}</h3>
      ...
      <section className="section-shell relative pt-6 sm:pt-8 lg:pt-10">
        <div className="relative overflow-hidden">
          <div className="relative z-10 mx-auto max-w-4xl text-center">
            ...
            <Reveal delay={120}>
              <h1 className="mx-auto mt-7 max-w-[12ch] font-display text-[clamp(3rem,6.4vw,5.8rem)] font-extrabold leading-[0.94]  text-[color:var(--foreground)]">
                Stavby, cenníky
                <br />
                a fakturácia
                <br />
        ...
        <div className="grid gap-4 lg:grid-cols-[0.9fr_1.1fr]">
          <Reveal>
            <div className="panel p-8">
              ...
              <h2 className="mt-4 font-display text-5xl font-extrabold  text-[color:var(--foreground)]">Od projektu po faktúru.</h2>
              ...
              <Reveal key={item.step} delay={index * 90}>
                <div className="panel flex h-full flex-col p-6">
                  <div className="flex items-center justify-between">
                    <span className="font-display text-4xl font-extrabold  text-[color:var(--foreground)]">{item.step}</span>
                  ...
                  <h3 className="mt-6 font-display text-3xl font-extrabold  text-[color:var(--foreground)]">{item.title}</h3>
