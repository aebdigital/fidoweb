    ...
    <div className="relative overflow-hidden rounded-[2rem] border border-white/40 shadow-[0_24px_60px_rgba(15,15,15,0.18)]">
      ...
      <div className="absolute inset-x-0 bottom-0 flex items-end justify-between gap-4 p-5">
        <div>
          ...
          <h3 className="mt-2 font-display text-3xl font-black text-white">{title}</h3>
        </div>
        {liveLabel ? (
...
function SurfaceCard({ title, body, value }: { title: string; body: string; value: string }) {
  return (
    <div className="panel h-full p-5">
      ...
      <p className="mt-4 font-display text-4xl font-black tracking-tight text-[color:var(--foreground)]">{value}</p>
        ...
        <div className="space-y-10 lg:space-y-12">
          <div className="relative z-10 max-w-[76rem] space-y-8">
            <div className="space-y-6">
              ...
              <h1 className="max-w-[10.5ch] font-display text-[clamp(4rem,9vw,8.4rem)] font-black leading-[0.9] tracking-[-0.04em] text-[color:var(--foreground)]">
                Najprv biela.
                <br />
                Čierny text.
                <br />
            ...
            <div className="grid gap-3 md:max-w-4xl md:grid-cols-3">
              {metrics.map((metric) => (
                <div key={metric.label} className="panel p-5">
                  <p className="font-display text-4xl font-black tracking-[-0.05em] text-[color:var(--foreground)]">{metric.value}</p>
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-4 lg:grid-cols-[0.9fr_1.1fr]">
                <div className="panel p-5">
                  ...
                  <h2 className="mt-3 font-display text-4xl font-black tracking-[-0.05em] text-[color:var(--foreground)]">SF Pro Display Heavy</h2>
                ...
                <div className="panel flex flex-col gap-6 p-5 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    ...
                    <h3 className="mt-3 max-w-md font-display text-3xl font-black tracking-[-0.05em] text-[color:var(--foreground)]">Čistý svetlý režim a potom jeho presný vizuálny opak.</h3>
                  </div>
        ...
        <div className="grid gap-4 lg:grid-cols-[0.92fr_1.08fr]">
          <div className="panel flex flex-col justify-between p-8">
            <div>
              ...
              <h2 className="mt-4 font-display text-5xl font-black tracking-[-0.06em] text-[color:var(--foreground)]">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="panel p-6">
              ...
              <h3 className="mt-3 font-display text-3xl font-black tracking-[-0.05em] text-[color:var(--foreground)]">Ťažké 40pt titulky</h3>
            ...
            <div className="panel p-6 dark:bg-[linear-gradient(160deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))]">
              ...
              <h3 className="mt-3 font-display text-3xl font-black tracking-[-0.05em] text-[color:var(--foreground)]">Sidebar, karty a utilitná hierarchia</h3>
            ...
            <div className="panel p-6 sm:col-span-2">
              <div className="grid gap-5 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
                <div>
                  ...
                  <h3 className="mt-3 font-display text-4xl font-black tracking-[-0.05em] text-[color:var(--foreground)]">Kategórie projektov, obaly pohľadov aj obrazové panely prichádzajú z reálneho produktu.</h3>
                </div>
      ...
      <section id="views" className="section-shell pt-16 lg:pt-24">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <h2 className="mt-3 max-w-3xl font-display text-5xl font-black tracking-[-0.06em] text-[color:var(--foreground)]">
        ...
        <div className="mt-8 grid gap-5 xl:grid-cols-[0.82fr_1.18fr]">
          <div className="panel flex flex-col p-8">
            ...
            <h3 className="mt-4 font-display text-4xl font-black tracking-[-0.06em] text-[color:var(--foreground)]">{activeSection.title}</h3>
            ...
            <div className="grid gap-4 lg:grid-cols-[1fr_16rem]">
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
                <div className="rounded-[1.8rem] border border-[color:var(--line)] bg-[color:var(--surface)] p-5">
                  ...
                  <h4 className="mt-3 font-display text-3xl font-black tracking-[-0.05em] text-[color:var(--foreground)]">{activeSection.label}</h4>
                ...
                <div className="rounded-[1.8rem] border border-[color:var(--line)] bg-[color:var(--foreground)] p-5 text-[color:var(--background)] shadow-[0_24px_70px_rgba(10,10,10,0.18)]">
                  ...
                  <p className="mt-4 font-display text-3xl font-black tracking-[-0.05em]">Appka už mala správnu náladu.</p>
          ...
          {workflowSteps.map((step) => (
            <div key={step.step} className="panel group flex h-full flex-col p-5 transition duration-300 hover:-translate-y-1.5">
              <div className="flex items-center justify-between">
                <span className="font-display text-4xl font-black tracking-[-0.05em] text-[color:var(--foreground)]">{step.step}</span>
              ...
              <h3 className="mt-6 font-display text-3xl font-black tracking-[-0.05em] text-[color:var(--foreground)]">{step.title}</h3>
        ...
        <div className="panel overflow-hidden p-0">
          <div className="grid gap-px bg-[color:var(--line)] lg:grid-cols-2">
            <div className="bg-white p-8 text-black lg:p-10">
              ...
              <h2 className="mt-4 font-display text-5xl font-black tracking-[-0.06em]">Čistá biela, tvrdá čierna, zdržanlivá sivá.</h2>
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-2">
                <div className="rounded-[1.8rem] border border-black/10 bg-black px-5 py-6 text-white shadow-[0_24px_60px_rgba(0,0,0,0.12)]">
                  ...
                  <p className="mt-4 font-display text-3xl font-black tracking-[-0.05em]">Vytvoriť ponuku</p>
                </div>
                <div className="rounded-[1.8rem] border border-black/10 bg-black/[0.05] px-5 py-6">
                  ...
                  <p className="mt-4 font-display text-3xl font-black tracking-[-0.05em]">Detaily klienta</p>
                </div>
              </div>
            </div>
            <div className="bg-black p-8 text-white lg:p-10">
              <p className="text-xs uppercase tracking-[0.25em] text-white/45">Tmavý režim</p>
              <h2 className="mt-4 font-display text-5xl font-black tracking-[-0.06em]">Presný inverz, nie iná osobnosť.</h2>
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-2">
                <div className="rounded-[1.8rem] border border-white/10 bg-white px-5 py-6 text-black shadow-[0_24px_60px_rgba(0,0,0,0.25)]">
                  ...
                  <p className="mt-4 font-display text-3xl font-black tracking-[-0.05em]">Vygenerovať faktúru</p>
                </div>
                <div className="rounded-[1.8rem] border border-white/10 bg-white/[0.06] px-5 py-6">
                  ...
                  <p className="mt-4 font-display text-3xl font-black tracking-[-0.05em]">Nastavenia archívu</p>
                </div>
              </div>
            </div>
          </div>
